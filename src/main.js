const quotes = ["Not all those who wander are lost - J. R. R. Tolkien",
			  ...
			  "A wise man proportions his belief to the evidence. - Daivd Hume",
			  "Happiness can be found, even in the darkest of times, if one only remembers to turn on the light. - J.K. Rolwing",
